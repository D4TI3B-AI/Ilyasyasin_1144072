graph = {'Ciwaruga': ['Sersan Bajuri', 'Cigugur','sarijadi'],
             'Sersan Bajuri': ['Hijau Indah',' Ciwaruga'],
             'Pinus Raya': ['Cigugur','Ciwaruga'],
             'gegerkalong': ['sarijadi','ciwaruga'],
             'sarijadi': ['gegerkalong','ciwaruga'],
